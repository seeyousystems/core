...
QWidget* CoreFactory::createGUIView(Create *create, QString name, QSettings *additionalSettings) {
	...
	if(name == "Viewport") {
		...
		Viewport *viewport = new Viewport(create->intSetting("Map_Scale"), updateInterval, openGL);
		...
		MapOverview *mapOverview = new MapOverview(create->mapWidth, create->mapHeight, create->scale, updateInterval, openGL);
...
//		TaskEditor *taskEditor = new TaskEditor(create);
//		return taskEditor;
		...
		WeightEditor *weightEditor = new WeightEditor(create);
		return weightEditor;

	} else if(name == "CameraView") {

//		// Show a new camera view
//		CameraView *view = new CameraView(create->stringSetting("Camera_CaptureToolPath"),
//											create->stringSetting("Camera_CaptureToolCommand"),
//											QString("%1%2").arg(Util::getResourcesFilePath()).arg(create->stringSetting("Camera_CaptureToolOutFile")),
//											create->intSetting("Camera_AutoRefreshInterval"));
//		return view;

	} else if(name == "TextToSpeechView") {

//		// Show a new text to speech view
//		TextToSpeechView *view = new TextToSpeechView(create->stringSetting("TextToSpeech_SpeakToolPath"),
//															create->stringSetting("TextToSpeech_SpeakToolCommand"));
//		return view;

	} else if(name == "RemoteInterfaceView") {

//		// Show a new remote interface view
//		RemoteInterfaceView *view = new RemoteInterfaceView(create);
//		return view;
...
//		return view;
		...
		MapObjectsView *view = new MapObjectsView(create);
		return view;

	} else if(name == "DockingStationView") {

//		// Show a new docking station view
//		DockingStationView *view = new DockingStationView(create);
//		return view;

	} else if (name == "CoreSettingsEditor"){

//		SettingsEditor *settingsEditor = new SettingsEditor(create->settings);
...
//
//		RobotControlPanel *controlPanel = new RobotControlPanel(create);
//		return controlPanel;

	} else if (name == "RobotSpeedGraph"){

//		RobotSpeedGraph *speedGraph = new RobotSpeedGraph(create);
//		return speedGraph;
