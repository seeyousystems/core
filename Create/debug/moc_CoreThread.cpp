...
static const char qt_meta_stringdata_CoreThread[] = {
    "CoreThread\0"
};

const QMetaObject CoreThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CoreThread,
      qt_meta_data_CoreThread, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CoreThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CoreThread))
