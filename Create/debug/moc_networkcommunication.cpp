...
**
** Created: Sun May 1 00:15:58 2011
...
static const char qt_meta_stringdata_NetworkCommunication[] = {
    "NetworkCommunication\0\0yokeX,yokeY\0"
    "yokeChanged(double,double)\0"
};

const QMetaObject NetworkCommunication::staticMetaObject = {
    { &Network::staticMetaObject, qt_meta_stringdata_NetworkCommunication,
      qt_meta_data_NetworkCommunication, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &NetworkCommunication::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NetworkCommunication))
...
// SIGNAL 0
void NetworkCommunication::yokeChanged(double _t1, double _t2)
{
